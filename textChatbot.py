...
class ChatInterface(Frame):
    ...
    def create_text_frame(self):
        text_frame = Frame(self.master, bd=6)
        ...
        self.text_box = Text(
            text_frame,
            yscrollcommand=text_box_scrollbar.set,
            state=DISABLED,
            bd=1,
            padx=6,
            pady=6,
    ...
    def create_entry_frame(self):
        entry_frame = Frame(self.master, bd=1)
    ...
    def create_send_button_frame(self):
        send_button_frame = Frame(self.master, bd=0)
        ...
        send_button = Button(
            ...
            bg="white",
            bd=1,
            command=self.send_message_insert,
    ...
    def last_sent_label(self, date):
        ...
        self.sent_label = Label(
            self.entry_frame, font="Verdana 7", text=date, bg=self.default_bg, fg=self.default_fg
        )
